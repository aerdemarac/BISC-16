...
def ADDS(r1, r2):        return encoder_modR(OP_ADDS, r1, r2)
def SUB(r1, r2):         return encoder_modR(OP_SUB, r1, r2)
def SUBI(r1, imm):       return encoder_modI(OP_SUBI, r1, imm)
def SUBS(r1, r2):        return encoder_modR(OP_SUBS, r1, r2)
def AND(r1, r2):         return encoder_modR(OP_AND, r1, r2)
def ANDI(r1, imm):       return encoder_modI(OP_ANDI, r1, imm)
def OR(r1, r2):          return encoder_modR(OP_OR, r1, r2)
def ORI(r1, imm):        return encoder_modI(OP_ORI, r1, imm)
def ZOR(r1, r2):         return encoder_modR(OP_ZOR, r1, r2)
...
def CMPW(r1, r2):        return encoder_modR(OP_CMPW, r1, r2)
def CMPH(r1, r2):        return encoder_modR(OP_CMPH, r1, r2)
